...
urlpatterns = [
                  ...
                  path('api/add_receivable', views.AddReceivable.as_view()),
                  ...
                  path('api/add_expend', views.AddExpend.as_view()),
                  ...
                  path('api/setup_dep_name', views.AddNewDepartment.as_view()),
                  path('api/add_department_admin', views.AddLeaderToNewDepartment.as_view()),
                  path('api/add_financial_staff', views.AddFinancialStaff.as_view())
